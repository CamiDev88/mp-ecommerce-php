<?php  
	...
	// Redirect to back_url (because in modal this doesn't work automatically)
	...
	if(isset($_GET['status'])){
		switch ($_GET['status']) {
			case 'success':
				// INICIAMOS EL CURL
				$request_url  = 'https://api.mercadopago.com/v1/payments/'.$_GET['collection_id'].'?access_token='.MP_ACCESS_TOKEN;
